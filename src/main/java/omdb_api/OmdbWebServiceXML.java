...
public class OmdbWebServiceXML {
	public static final String SEARCH_URL_TITLE = "http://www.omdbapi.com/?s=TITLE&y=YEAR&apikey=89efbed7&r=xml";
	...
	public static String searchMovieByTitle(String title,String year) throws Exception  {
		title = URLEncoder.encode(title,"UTF-8");
        String requestUrl = SEARCH_URL_TITLE .replaceAll("TITLE",title).replaceAll("YEAR", year);
    ...
    public static String getMovieImdbId(String movie_name,String year) throws Exception {
    	
    	
    	String movie_xml_content = searchMovieByTitle(movie_name, year);
    ...
    public static String getMoviePlot(String movie_name,String year) throws Exception {
    
    	String movie_id = getMovieImdbId(movie_name, year);    	
	...
	public static void main(String[] args) throws Exception {
		//System.out.println(getMoviePlot("fqjlqfHLQIHFDQLKJUFHQJKFQUG"));
		System.out.println(getMoviePlot("Ben-Hur","1925" ));
